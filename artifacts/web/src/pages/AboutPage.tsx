      ...
      <main className="flex-1">
        ...
        <SectionWrapper id="mission-vision" variant="muted">
          <div className="grid gap-8 md:grid-cols-2">
            <div className="bg-background p-8 rounded-xl border border-border shadow-sm hover-elevate">
        ...
        <SectionWrapper id="values">
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
            {[1, 2, 3, 4, 5, 6].map((num) => (
              <div
                key={num}
                className="p-8 rounded-xl border border-border bg-card text-center hover-elevate-2 transition-all"
